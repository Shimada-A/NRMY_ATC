namespace Wms.Areas.Ship.ViewModels.TransporterChng
{
    ...
    /// </summary>
    public class TransporterChngSearchConditions 
    {
        /// <summary>
        /// 引当状況
        /// </summary>
        ...
        {
            [Display(Name = nameof(TransporterChngResource.UnAlloc), ResourceType = typeof(TransporterChngResource))]
            UnAlloc = 1,

            [Display(Name = nameof(TransporterChngResource.Alloced), ResourceType = typeof(TransporterChngResource))]
            Alloced = 2
        }
        ...
        public IList<SelectedTransporterChngViewModel> TransporterChngs { get; set; }
    }
}