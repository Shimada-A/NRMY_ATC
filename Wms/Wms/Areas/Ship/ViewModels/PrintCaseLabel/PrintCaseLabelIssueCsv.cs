namespace Wms.Areas.Ship.ViewModels.PrintCaseLabel
{
    ...
    /// CSV
    /// </summary>
    public class PrintCaseLabelIssueCsv
    {
        /// <summary>
        /// センター
        /// </summary>
        ...
        /// 再発行フラグ
        /// </summary>
        [Display(Name = nameof(Resources.PrintCaseLabelResource.DispIssueFlag), ResourceType = typeof(Resources.PrintCaseLabelResource), Order = 7)]
        public int DispIssueFlag { get; set; }

        /// <summary>
        /// 間口No
        /// </summary>
        [Display(Name = nameof(Resources.PrintCaseLabelResource.FrontageNo), ResourceType = typeof(Resources.PrintCaseLabelResource), Order = 8)]
        public string FrontageNo { get; set; }

        /// <summary>
        /// ブランド名
        /// </summary>
        [Display(Name = nameof(Resources.PrintCaseLabelResource.BrandName), ResourceType = typeof(Resources.PrintCaseLabelResource), Order = 9)]
