namespace Wms.Areas.Ship.ViewModels.TransporterChngEc
{
    ...
    public class TransporterChngEcPrint
    {
        /// <summary>
        /// センター
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        [Display(Name = nameof(DcAllocationResource.DivisionId), ResourceType = typeof(DcAllocationResource), Order = 4)]
        ...
        /// </summary>
        /// <remarks>
        [Display(Name = nameof(DcAllocationResource.DivisionName), ResourceType = typeof(DcAllocationResource), Order = 5)]
