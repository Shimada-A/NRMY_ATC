namespace Wms.Areas.Ship.ViewModels.BtoBReference
{
    ...
    /// </summary>
    public class BtoBReference01SearchConditions
    {
        /// <summary>
        /// Data to sort
        /// </summary>
        public enum BtoBReference01SortKey : byte
        {
            [Display(Name = nameof(Resources.BtoBReferenceResource.BoxNo), ResourceType = typeof(Resources.BtoBReferenceResource))]
            BoxNo,

            [Display(Name = nameof(Resources.BtoBReferenceResource.ShipToStoreIdBoxNo), ResourceType = typeof(Resources.BtoBReferenceResource))]
            ShipToStoreIdBoxNo
        }
        ...
        /// 状態
        /// </summary>
        public string ShipBoxStatus { get; set; }

        /// <summary>
        /// 状態(過去分を含む)
        /// </summary>
        public bool ShipBoxStatusOld { get; set; }
        ...
        /// Sort key
        /// </summary>
        public BtoBReference01SortKey SortKey { get; set; } = BtoBReference01SortKey.BoxNo;
        ...
        public IList<SelectedBtoBReference01ViewModel> BtoBReference01s { get; set; }
    }
}