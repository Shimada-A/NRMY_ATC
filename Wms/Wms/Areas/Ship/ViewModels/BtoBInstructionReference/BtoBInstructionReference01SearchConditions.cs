namespace Wms.Areas.Ship.ViewModels.BtoBInstructionReference
{
    ...
    /// </summary>
    public class BtoBInstructionReference01SearchConditions
    {
        /// <summary>
        /// Data to sort
        /// </summary>
        public enum BtoBInstructionReference01SortKey : byte
        {
            [Display(Name = nameof(Resources.BtoBInstructionReferenceResource.ShipPlanDateInstructIdSku), ResourceType = typeof(Resources.BtoBInstructionReferenceResource))]
            ShipPlanDateInstructIdSku,

            [Display(Name = nameof(Resources.BtoBInstructionReferenceResource.SkuInstructId), ResourceType = typeof(Resources.BtoBInstructionReferenceResource))]
            SkuInstructId
        }
        ...
        /// Detail Data to sort
        /// </summary>
        public enum BtoBInstructionReferenceDetailSortKey : byte
        {
            [Display(Name = nameof(Resources.BtoBInstructionReferenceResource.ShipPlanDateInstructIdSeq), ResourceType = typeof(Resources.BtoBInstructionReferenceResource))]
            ShipPlanDateInstructIdSeq,

            [Display(Name = nameof(Resources.BtoBInstructionReferenceResource.ShipToStoreInstructIdSeq), ResourceType = typeof(Resources.BtoBInstructionReferenceResource))]
            ShipToStoreInstructIdSeq,

            [Display(Name = nameof(Resources.BtoBInstructionReferenceResource.SkuInstructIdSeq), ResourceType = typeof(Resources.BtoBInstructionReferenceResource))]
            SkuInstructIdSeq
        }
        ...
        /// Sort key
        /// </summary>
        public BtoBInstructionReference01SortKey SortKey { get; set; } = BtoBInstructionReference01SortKey.ShipPlanDateInstructIdSku;

        /// <summary>
        /// Detail Sort key
        /// </summary>
        public BtoBInstructionReferenceDetailSortKey DetailSortKey { get; set; } = BtoBInstructionReferenceDetailSortKey.ShipPlanDateInstructIdSeq;
        ...
        public int? ShipInstructIdSum { get; set; }
        ...
        public IList<SelectedBtoBInstructionReference01ViewModel> BtoBInstructionReference01s { get; set; }
