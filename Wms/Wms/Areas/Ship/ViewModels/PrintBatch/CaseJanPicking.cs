namespace Wms.Areas.Ship.ViewModels.PrintBatch
{
    ...
    public class CaseJanPicking
    {
        ...
        /// 品番
        /// </summary>
        [Display(Name = nameof(PrintBatchResource.ItemId1), ResourceType = typeof(PrintBatchResource), Order = 11)]
        public string ItemId { get; set; }

        /// <summary>
        /// 品名
        /// </summary>
        [Display(Name = nameof(PrintBatchResource.ItemName), ResourceType = typeof(PrintBatchResource), Order = 12)]
        public string ItemName { get; set; }

        /// <summary>
        /// カラーID
        /// </summary>
        [Display(Name = nameof(PrintBatchResource.ItemColorId), ResourceType = typeof(PrintBatchResource), Order = 13)]
        public string ItemColorId { get; set; }

        /// <summary>
        /// カラー名
        /// </summary>
        [Display(Name = nameof(PrintBatchResource.ItemColorName), ResourceType = typeof(PrintBatchResource), Order = 14)]
        public string ItemColorName { get; set; }

        /// <summary>
        /// サイズID
        /// </summary>
        [Display(Name = nameof(PrintBatchResource.ItemSizeId), ResourceType = typeof(PrintBatchResource), Order = 15)]
        public string ItemSizeId { get; set; }

        /// <summary>
        /// サイズ名
        /// </summary>
        [Display(Name = nameof(PrintBatchResource.ItemSizeName), ResourceType = typeof(PrintBatchResource), Order = 16)]
        public string ItemSizeName { get; set; }

        /// <summary>
        /// 指示数
        /// </summary>
        [Display(Name = nameof(PrintBatchResource.HikiQty), ResourceType = typeof(PrintBatchResource), Order = 17)]
        public int? HikiQty { get; set; }

        /// <summary>
        /// JAN
        /// </summary>
        [Display(Name = nameof(PrintBatchResource.JanH), ResourceType = typeof(PrintBatchResource), Order = 18)]
        public string Jan { get; set; }

        /// <summary>
        /// 行番号
        /// </summary>
        [Display(Name = nameof(PrintBatchResource.ListSeq), ResourceType = typeof(PrintBatchResource), Order = 19)]
