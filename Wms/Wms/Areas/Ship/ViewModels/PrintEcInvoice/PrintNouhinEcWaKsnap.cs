namespace Wms.Areas.Ship.ViewModels.PrintEcInvoice
{
    ...
    /// </summary> 
    public class PrintNouhinEcWaKsnap
    {
        ...
        [Display(Name = nameof(PrintEcInvoiceResource.EcOkaiageMessage228), ResourceType = typeof(PrintEcInvoiceResource), Order = 62)]
        public string EcOkaiageMessage228 { get; set; }

        [Display(Name = nameof(PrintEcInvoiceResource.EcOkaiageMessage229), ResourceType = typeof(PrintEcInvoiceResource), Order = 63)]
        public string EcOkaiageMessage229 { get; set; }

        [Display(Name = nameof(PrintEcInvoiceResource.EcOkaiageMessage230), ResourceType = typeof(PrintEcInvoiceResource), Order = 64)]
        public string EcOkaiageMessage230 { get; set; }

        [Display(Name = nameof(PrintEcInvoiceResource.EcOkaiageMessage31), ResourceType = typeof(PrintEcInvoiceResource), Order = 65)]
        public string EcOkaiageMessage31 { get; set; }

        [Display(Name = nameof(PrintEcInvoiceResource.EcOkaiageMessage32), ResourceType = typeof(PrintEcInvoiceResource), Order = 66)]
