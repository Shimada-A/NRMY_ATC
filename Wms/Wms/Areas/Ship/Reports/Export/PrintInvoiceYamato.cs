namespace Wms.Areas.Ship.Reports.Export
{
    ...
    /// 出力クラス
    /// </summary>
    public class PrintInvoiceYamato : BaseExportReport<ViewModels.PrintInvoice.PrintInvoiceYamato>, IReportExportable<ViewModels.PrintInvoice.PrintInvoiceYamato>
    {
        /// <summary>
        /// 検索条件
        /// </summary>
        ...
        public PrintInvoiceYamato(ReportTypes reportType, PrintInvoiceConditions search)
            : base(reportType)
        {
            this._search = search;
        }
