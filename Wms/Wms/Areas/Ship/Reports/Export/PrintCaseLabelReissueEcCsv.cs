namespace Wms.Areas.Ship.Reports.Export
{
    ...
    /// サンプル出力クラス
    /// </summary>
    public class PrintCaseLabelReissueEcCsv : BaseExportReport<ViewModels.PrintCaseLabel.PrintCaseLabelIssueCsv>, IReportExportable<ViewModels.PrintCaseLabel.PrintCaseLabelIssueCsv>
    {
        /// <summary>
        /// 検索条件
        /// </summary>
        ...
        public PrintCaseLabelReissueEcCsv(ReportTypes reportType, PrintCaseLabelConditions search)
            : base(reportType)
        {
            this._search = search;
        }
        ...
        public override IEnumerable<ViewModels.PrintCaseLabel.PrintCaseLabelIssueCsv> GetData()
        {
            ...
            IEnumerable<ViewModels.PrintCaseLabel.PrintCaseLabelIssueCsv> data = query.PrintCaseLabelReissueEcListing(this._search);
