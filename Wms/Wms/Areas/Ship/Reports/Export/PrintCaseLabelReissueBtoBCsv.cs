namespace Wms.Areas.Ship.Reports.Export
{
    ...
    /// サンプル出力クラス
    /// </summary>
    public class PrintCaseLabelReissueBtoBCsv : BaseExportReport<ViewModels.PrintCaseLabel.PrintCaseLabelIssueCsv>, IReportExportable<ViewModels.PrintCaseLabel.PrintCaseLabelIssueCsv>
    {
        /// <summary>
        /// 検索条件
        /// </summary>
        ...
        public PrintCaseLabelReissueBtoBCsv(ReportTypes reportType, PrintCaseLabelConditions search)
            : base(reportType)
        {
            this._search = search;
        }
        ...
        public override IEnumerable<ViewModels.PrintCaseLabel.PrintCaseLabelIssueCsv> GetData()
        {
            ...
            IEnumerable<ViewModels.PrintCaseLabel.PrintCaseLabelIssueCsv> data = query.PrintCaseLabelReissueBtoBListing(this._search);
