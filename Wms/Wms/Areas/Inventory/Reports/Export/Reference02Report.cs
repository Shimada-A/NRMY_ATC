namespace Wms.Areas.Inventory.Reports.Export
{
    ...
    /// サンプル出力クラス
    /// </summary>
    public class Reference02Report : BaseExportReport<ViewModels.Reference.ReferenceReport>, IReportExportable<ViewModels.Reference.ReferenceReport>
    {
        /// <summary>
        /// 検索条件
        /// </summary>
        ...
        public Reference02Report(ReportTypes reportType, Reference02SearchConditions search)
            : base(reportType)
        {
            this._search = search;
        }
        ...
        public override IEnumerable<ViewModels.Reference.ReferenceReport> GetData()
        {
            ...
            IEnumerable<ViewModels.Reference.ReferenceReport> data = query.Reference02Listing(this._search);
