namespace Wms.Areas.Inventory.Reports.Export
{
    ...
    /// サンプル出力クラス
    /// </summary>
    public class Reference03Report : BaseExportReport<ViewModels.Reference.ReferenceReport>, IReportExportable<ViewModels.Reference.ReferenceReport>
    {
        /// <summary>
        /// 検索条件
        /// </summary>
        ...
        public Reference03Report(ReportTypes reportType, Reference02SearchConditions search)
            : base(reportType)
        {
            this._search = search;
        }
        ...
        public override IEnumerable<ViewModels.Reference.ReferenceReport> GetData()
        {
            ...
            IEnumerable<ViewModels.Reference.ReferenceReport> data = query.Reference03Listing(this._search);
