namespace Wms.Areas.Inventory.Reports.Export
{
    ...
    /// サンプル出力クラス
    /// </summary>
    public class Reference01ReportForCsv : BaseExportReport<ViewModels.Reference.ReferenceReportForCsv>, IReportExportable<ViewModels.Reference.ReferenceReportForCsv>
    {
        /// <summary>
        /// 検索条件
        /// </summary>
        ...
        public Reference01ReportForCsv(ReportTypes reportType, Reference01SearchConditions search)
            : base(reportType)
        {
            this._search = search;
        }
        ...
        public override IEnumerable<ViewModels.Reference.ReferenceReportForCsv> GetData()
        {
            ...
            return query.Reference01ListingForCsv(this._search);
        }
