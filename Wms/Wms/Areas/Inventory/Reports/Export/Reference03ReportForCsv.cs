namespace Wms.Areas.Inventory.Reports.Export
{
    ...
    /// サンプル出力クラス
    /// </summary>
    public class Reference03ReportForCsv : BaseExportReport<ViewModels.Reference.ReferenceReportForCsv>, IReportExportable<ViewModels.Reference.ReferenceReportForCsv>
    {
        /// <summary>
        /// 検索条件
        /// </summary>
        ...
        public Reference03ReportForCsv(ReportTypes reportType, Reference02SearchConditions search)
            : base(reportType)
        {
            this._search = search;
        }
        ...
        public override IEnumerable<ViewModels.Reference.ReferenceReportForCsv> GetData()
        {
            ...
            return query.Reference03ListingForCsv(this._search);
        }
