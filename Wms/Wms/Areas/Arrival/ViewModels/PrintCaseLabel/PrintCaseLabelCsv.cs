namespace Wms.Areas.Arrival.ViewModels.PrintCaseLabel
{
    ...
    /// CSV
    /// </summary>
    public class PrintCaseLabelCsv
    {
        /// <summary>
        /// センター
        /// </summary>
        ...
        /// 再発行フラグ
        /// </summary>
        [Display(Name = nameof(Resources.PrintCaseLabelResource.DispIssueFlag), ResourceType = typeof(Resources.PrintCaseLabelResource), Order = 11)]
