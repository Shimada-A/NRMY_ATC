namespace Wms.Areas.Arrival.ViewModels.PurchaseReference
{
    ...
    public class PurchaseReference02DetailReport
    {
        ...
        /// </summary>
        /// <remarks>
        [Display(Name = nameof(PurchaseReferenceResource.ArrivePlanQty), ResourceType = typeof(PurchaseReferenceResource), Order = 15)]
        ...
        /// </summary>
        /// <remarks>
        [Display(Name = nameof(PurchaseReferenceResource.ResultQty), ResourceType = typeof(PurchaseReferenceResource), Order = 16)]
        [DisplayFormat(DataFormatString = "{0:N0}")]
        ...
        /// </summary>
        /// <remarks>
        [Display(Name = nameof(PurchaseReferenceResource.DifferenceQty), ResourceType = typeof(PurchaseReferenceResource), Order = 17)]
        [DisplayFormat(DataFormatString = "{0:N0}")]
        ...
        /// </summary>
        /// <remarks>
        [Display(Name = nameof(PurchaseReferenceResource.ArrivalStatus), ResourceType = typeof(PurchaseReferenceResource), Order = 18)]
        ...
        /// </summary>
        /// <remarks>
        [Display(Name = nameof(PurchaseReferenceResource.ArrivalStatusName), ResourceType = typeof(PurchaseReferenceResource), Order = 19)]
        ...
        ///// </summary>
        ///// <remarks>
        //[Display(Name = nameof(PurchaseReferenceResource.WmsInstructQty), ResourceType = typeof(PurchaseReferenceResource), Order = 20)]
        //[DisplayFormat(DataFormatString = "{0:N0}")]
        ...
        ///// </summary>
        ///// <remarks>
        //[Display(Name = nameof(PurchaseReferenceResource.StoragePlanQty), ResourceType = typeof(PurchaseReferenceResource), Order = 21)]
        //[DisplayFormat(DataFormatString = "{0:N0}")]
        ...
        /// </summary>
        /// <remarks>
        [Display(Name = nameof(Resources.PurchaseReferenceResource.ConfirmDate), ResourceType = typeof(Resources.PurchaseReferenceResource), Order = 22)]
        [DisplayFormat(DataFormatString = "{0:d}")]
        ...
        /// </summary>
        /// <remarks>
        [Display(Name = nameof(Resources.PurchaseReferenceResource.IfRunDate), ResourceType = typeof(Resources.PurchaseReferenceResource), Order = 23)]
        [DisplayFormat(DataFormatString = "{0:d}")]
