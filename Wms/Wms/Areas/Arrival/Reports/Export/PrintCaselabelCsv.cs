namespace Wms.Areas.Arrival.Reports.Export
{
    ...
    /// サンプル出力クラス
    /// </summary>
    public class PrintCaseLabelCsv : BaseExportReport<ViewModels.PrintCaseLabel.PrintCaseLabelCsv>, IReportExportable<ViewModels.PrintCaseLabel.PrintCaseLabelCsv>
    {
        /// <summary>
        /// 検索条件
        /// </summary>
        ...
        public PrintCaseLabelCsv(ReportTypes reportType, PrintCaseLabelConditions search)
            : base(reportType)
        {
            this._search = search;
        }
        ...
        public override IEnumerable<ViewModels.PrintCaseLabel.PrintCaseLabelCsv> GetData()
        {
            ...
            IEnumerable<ViewModels.PrintCaseLabel.PrintCaseLabelCsv> data = query.PrintCaseLabelListing(this._search);
