namespace Wms.Areas.Arrival.Reports.Export
{
    ...
    /// サンプル出力クラス
    /// </summary>
    public class PurchaseReference01JanCsv : BaseExportReport<ViewModels.PurchaseReference.PurchaseReferenceCsv>, IReportExportable<ViewModels.PurchaseReference.PurchaseReferenceCsv>
    {
        /// <summary>
        /// 検索条件
        /// </summary>
        ...
        public PurchaseReference01JanCsv(ReportTypes reportType, PurchaseReference02SearchConditions search)
            : base(reportType)
        {
            this._search = search;
        }
        ...
        public override IEnumerable<ViewModels.PurchaseReference.PurchaseReferenceCsv> GetData()
        {
            ...
            IEnumerable<ViewModels.PurchaseReference.PurchaseReferenceCsv> data = query.GetPurchaseReferenceList(this._search, true);
        ...
        {
            return string.Format(ReportResource.RPT_PURCHASE_REFERENCE_JAN,
                Profile.User.UserId,
