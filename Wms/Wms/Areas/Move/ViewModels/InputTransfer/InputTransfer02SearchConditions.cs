namespace Wms.Areas.Move.ViewModels.InputTransfer
{
    ...
    /// </summary>
    [Serializable]
    public class InputTransfer02SearchConditions
    {
        /// <summary>
        /// Data to sort
        /// </summary>        
        public enum InputTransfer02Sort : byte
        {
            [Display(Name = nameof(Resources.InputTransferResource.SlipNoSlipSeq), ResourceType = typeof(Resources.InputTransferResource))]
            SlipNoSlipSeq,

            [Display(Name = nameof(Resources.InputTransferResource.StoreIdSlipNoBoxNoSku), ResourceType = typeof(Resources.InputTransferResource))]
            StoreIdSlipNoBoxNoSku,

            [Display(Name = nameof(Resources.InputTransferResource.SkuBoxNo), ResourceType = typeof(Resources.InputTransferResource))]
            SkuBoxNo
        }
        ...
        /// Sort key
        /// </summary>
        public InputTransfer02Sort SortKey { get; set; } = InputTransfer02Sort.SlipNoSlipSeq;
