namespace Wms.Areas.Move.ViewModels.InputTransfer
{
    ...
    /// </summary>
    public class InputTransfer01SearchConditions
    {
        /// <summary>
        /// Data to sort
        /// </summary>
        public enum InputTransfer01Sort : byte
        {
            [Display(Name = nameof(Resources.InputTransferResource.TransferClassDenpyoDateStoreId), ResourceType = typeof(Resources.InputTransferResource))]
            TransferClassDenpyoDateStoreId,

            [Display(Name = nameof(Resources.InputTransferResource.DenpyoDateTransferClassStoreId), ResourceType = typeof(Resources.InputTransferResource))]
            DenpyoDateTransferClassStoreId,

            [Display(Name = nameof(Resources.InputTransferResource.StoreIdDenpyoDate), ResourceType = typeof(Resources.InputTransferResource))]
            StoreIdDenpyoDate
        }
        ...
        /// 移動区分
        /// </summary>
        public enum TransferClasses
        {
            [Display(Name = nameof(Resources.TransferReferenceResource.BaseMove), ResourceType = typeof(Resources.TransferReferenceResource))]
            BaseMove = 1,

            [Display(Name = nameof(Resources.TransferReferenceResource.StoreReturn), ResourceType = typeof(Resources.TransferReferenceResource))]
            StoreReturn = 2,

            [Display(Name = nameof(Resources.TransferReferenceResource.BaseMoveNoWmsCenter), ResourceType = typeof(Resources.TransferReferenceResource))]
            BaseMoveNoWmsCenter = 3
        }
        ...
        /// Sort key
        /// </summary>
        public InputTransfer01Sort SortKey { get; set; } = InputTransfer01Sort.TransferClassDenpyoDateStoreId;
        ...
        public IList<SelectedInputTransfer01ViewModel> InputTransfer01s { get; set; }
    }
}