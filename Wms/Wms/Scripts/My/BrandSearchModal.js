/**
 * ブランド検索モーダル
 * _BrandSearchModal.cshtmlに必要
 */
var brandSearchModal = (function () {
    var current_scrollY;
    var id = '#brandSearchModalDialog';
    ...
    return {
        ...
        resize: function () {
            ...
            timer = setTimeout(function () { brandSearchModal.adjust(); }, 200);
        },
        /**
         * ウィンドウを閉じる(キャンセル)
         */
        ...
        saveChanges: function () {
            $("#selectedBrand").empty();
            $("input[type='hidden'][name='checkedBrand']").clone().appendTo("#selectedBrand");
        },
        /**
         * モーダルダイアログを開く
         */
        open: function () {
            ...
            //画面側の選択項目をコピー
            $("#checked").empty();
            $("#selectedBrand input[type='hidden'][name='checkedBrand']").clone().appendTo("#checked");
            ...
            checked.each(function () {
                ...
                var target = $("input[type='hidden'][name$='Brand.BrandId']").filter("[value='" + $(this).val() + "']");
        ...
        setCheckBoxCounter: function () {
            ...
            $("#btnBrandSearchFreeWord").on("click", this.BrandSearchChange);
        },
        /**
         * 再検索
         */
        BrandSearchChange: function () {
        ...
        init: function () {
            ...
            $('#brandClose').on('click', this.close);
            $('#brandSelect').on('click', this.close);
            $("#brandSelect").on("click", this.saveChanges);
